...
- **現在(可玩)**:**台北關**(圖釘 → 夜市 → 機車海 → 萬華街屋宮廟 → 信義天際線 → **台北 101**)、**高雄關**(鹽埕 → 六合夜市 → 駁二 → 旗津 → **高雄 85 大樓**)、**台中關**(中區老城 → 逢甲夜市 → 一中商圈 → 台灣大道 → 南屯老街 → 七期 → **台中之鑽**)。進站時用**縣市選單**選城市。
...
- **縣市選單**:第一次造訪(網址沒有 `?city=`、瀏覽器也沒記錄)會先跳出**縣市選單**,選 **台北** 或 **高雄**。選過之後會記在 `localStorage`,下次直接進上次玩的城市。標題頁與結算頁右下角有「換城市」鈕可隨時叫回選單。
