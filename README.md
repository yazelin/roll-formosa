...
![Roll Formosa — 台灣風味的滾物成球遊戲,全台 20 城](public/assets/og.jpg)

> 滾啊滾,捲遍全台灣。

一款**台灣風味的 Katamari（滾物成球）瀏覽器 3D 遊戲** —— 開網頁就能玩,免安裝、手機也行,還能裝成 App 離線玩。

你從一顆 2 公分的圖釘開始,在台灣某座城市的街頭一路黏滾:先捲起柑仔店桌頭的彈珠、夜市攤食、整片機車海,越滾越大,最後變成一顆跨越街區、撞上城市招牌地標的巨球。畫面用**無縫相似縮放**把 2cm 到 300m 的尺度串成一氣、從不跳格 —— 滾起來像一顆停不下來的雪球。

**全台 20 城**,每一座都是一關,終點是那座一看就知道是哪裡的建築(台北 101、高雄 85 大樓、台南林百貨……);台灣黑熊「月牙」全程當你的在地導遊,邊滾邊介紹在地。

**線上試玩 ▶** https://yazelin.github.io/roll-formosa/

## 一封給台灣的情書

這是一款**邊玩邊認識台灣**的小遊戲。每一座城市都是一關,你會一路滾過：

- **夜市與小吃** —— 台南棺材板、擔仔麵、碗粿,基隆吉古拉、李鵠餅、泡泡冰,高雄木瓜牛奶、鹽埕鴨肉…… 各地名物一個個黏上球。
- **街頭日常** —— 機車海、柑仔店桌頭、廟宇與老街屋、紅綠燈與超商,把台灣街景的氣味捲進來。
- **在地名物與童玩** —— 每座城的收藏冊都是該地特產與文化符號(媽祖、黑熊、各城小吃)。
- **城市招牌地標** —— 終點是那座一看就知道是哪裡的建築:台北 101、高雄 85 大樓、台南林百貨、花蓮太魯閣、澎湖跨海大橋、金門莒光樓……

用 Katamari「滾物成球」的玩法,把台灣的**觀光景點、小吃、特色與夜市文化**包進一款好上手的瀏覽器遊戲 —— 想推廣台灣、想讓人會心一笑「這個我家那邊也有!」。
