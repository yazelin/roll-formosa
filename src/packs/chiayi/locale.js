/**
 * @file locale.js — zh-TW string table for the Chiayi pack.
 *
 ...
 *   t('hud.landmark', '阿里山神木')  // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '射日塔在呼喚你…！',
  'hud.goalGuide':    '朝射日塔前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全嘉義。 / Roll up all of Chiayi.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到 62m 射日塔 — From a 2cm pushpin to the Sun-Shooting Tower.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '嘉義，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP CHIAYI',
