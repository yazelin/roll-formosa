/**
 * @file locale.js — zh-TW string table for the Hualien pack.
 *
 ...
 *   t('hud.landmark', '燕子口')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '太魯閣牌樓在呼喚你…！',
  'hud.goalGuide':    '朝太魯閣牌樓前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍花蓮。 / Roll up all of Hualien.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到太魯閣牌樓 — From a 2cm pushpin to Taroko Gate.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '花蓮，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP HUALIEN',
