/**
 * @file locale.js — zh-TW string table for the Penghu pack.
 *
 ...
 *   t('hud.landmark', '天后宮')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '澎湖跨海大橋在呼喚你…！',
  'hud.goalGuide':    '朝跨海大橋前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全澎湖。 / Roll up all of Penghu.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到 2494m 澎湖跨海大橋 — From a 2cm pushpin to the Cross-Sea Bridge.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '澎湖，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP PENGHU',
