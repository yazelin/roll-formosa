/**
 * @file locale.js — zh-TW string table for the Changhua pack.
 *
...
const TABLE = {
  ...
  'hud.goalCall':     '八卦山大佛在呼喚你…！',
  'hud.goalGuide':    '朝八卦山前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍鹿港老街。 / Roll up all of Changhua.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到 22.5m 八卦山大佛 — From a 2cm pushpin to Baguashan Great Buddha.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '彰化，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP CHANGHUA',
