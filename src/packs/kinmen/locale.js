/**
 * @file locale.js — zh-TW string table for the Kinmen pack.
 *
 ...
 *   t('hud.landmark', '莒光樓')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '莒光樓 在呼喚你…！',
  'hud.goalGuide':    '朝莒光樓 前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全金門。 / Roll up all of Kinmen.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到莒光樓 — From a 2cm pushpin to Juguang Tower.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '金門，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP KINMEN',
