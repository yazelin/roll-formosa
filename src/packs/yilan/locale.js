/**
 * @file locale.js — zh-TW string table for the Yilan pack.
 *
 ...
 *   t('hud.landmark', '蘭陽博物館')  // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '龜山島在海上呼喚你…！',
  'hud.goalGuide':    '朝龜山島前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全宜蘭。 / Roll up all of Yilan.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到龜山島 — From a 2cm pushpin to Guishan Island.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '宜蘭，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP YILAN',
