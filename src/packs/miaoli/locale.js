/**
 * @file locale.js — zh-TW string table for the Miaoli pack.
 *
 ...
 *   t('hud.landmark', '勝興車站')    // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '龍騰斷橋在呼喚你…！',
  'hud.goalGuide':    '朝龍騰斷橋前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全苗栗。 / Roll up all of Miaoli.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到舊山線龍騰斷橋 — From a 2cm pushpin to Longteng Bridge.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '苗栗，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP MIAOLI',
