/**
 * @file packs/taipei/collectibles/budaixi.js — Roll Formosa Taipei collectible.
 *
 * 布袋戲偶 (budaixi / Taiwanese glove puppet). A small hand-held opera puppet:
 * an ornate carved head with a painted opera face (pale skin, dark brows, red
 * lips, rouge cheeks) crowned by a colourful headdress, sitting on a wide
 * draped colourful robe body whose two sleeves flare out — the unmistakable
 * 掌中戲 silhouette of a glove puppet held aloft.
 *
 * Built ONLY with the engine geometry vocabulary (geomHelpers.js) — the math is
 * an engine red line. finish() merges → recenters → normalizes to a UNIT
 * bounding sphere (radius 1), so this is authored in unit-ish space for correct
 * PROPORTIONS: a top-heavy figure (big carved head over a flaring robe), wider
 * than it is deep, the way a glove puppet hangs on a hand. rng only nudges tiny
 * non-structural details. Triangle budget kept well under 350.
 */
