/**
 * @file locale.js — zh-TW string table for the Nantou pack.
 *
 ...
 *   t('hud.landmark', '文武廟')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '慈恩塔在呼喚你…！',
  'hud.goalGuide':    '朝慈恩塔前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全南投。 / Roll up all of Nantou.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到日月潭慈恩塔 — From a 2cm pushpin to Ci-En Pagoda.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '南投，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP NANTOU',
