...
describe('kaohsiung chunk archetypes', () => {
...
describe('kaohsiung catalog surface', () => {
  it('merges chunk + Kaohsiung EXTRA into a full CATALOG keyed by id (99 ids resolve)', () => {
  ...
  it('DISPLAY_NAME_BY_CODE has zh-TW names at every code (de-Tokyo: no Japanese kana)', () => {
    ...
    // code 82 = 光之穹頂 (first curated Kaohsiung core landmark).
    expect(DISPLAY_NAME_BY_CODE[82]).toBe('美麗島站光之穹頂');
  });
});
