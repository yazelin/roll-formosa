/**
 * @file locale.js — zh-TW string table for the Taoyuan pack.
 *
 ...
 *   t('hud.landmark', '石門水庫')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '大溪老街牌樓在呼喚你…！',
  'hud.goalGuide':    '朝大溪老街牌樓前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全桃園。 / Roll up all of Taoyuan.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到大溪老街牌樓 — From a 2cm pushpin to Daxi Old Street.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '桃園，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP TAOYUAN',
