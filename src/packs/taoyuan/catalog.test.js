...
describe('taoyuan chunk archetypes', () => {
...
describe('taoyuan catalog surface', () => {
  it('merges chunk + EXTRA into a full CATALOG keyed by id (99 ids resolve)', () => {
    ...
    // Taoyuan collectibles resolve (codes 70 + 94).
  ...
  it('DISPLAY_NAME_BY_CODE has zh-TW names at every code (de-Tokyo: no Tokyo names left)', () => {
    ...
    // code 0 = T0 slot 0 = longan = 龍眼乾
    expect(DISPLAY_NAME_BY_CODE[0]).toBe('龍眼乾');
