/**
 * @file locale.js — zh-TW string table for the Matsu pack.
 *
 ...
 *   t('hud.landmark', '芹壁聚落')    // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '媽祖巨神像在呼喚你…！',
  'hud.goalGuide':    '朝媽祖巨神像前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍連江馬祖。 / Roll up all of Matsu.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到 29.6m 媽祖巨神像 — From a 2cm pushpin to the Mazu Goddess Statue.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '馬祖，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP MATSU',
