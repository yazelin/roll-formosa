...
const TABLE = {
  ...
  'hud.goalCall':     '林百貨在呼喚你…！',
  'hud.goalGuide':    '朝林百貨前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全台南。 / Roll up all of Tainan.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到 1932 年的林百貨 — From a 2cm pushpin to the Hayashi Department Store.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '台南，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP TAINAN',
