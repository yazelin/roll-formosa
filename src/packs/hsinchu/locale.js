/**
 * @file locale.js — zh-TW string table for the Hsinchu pack.
 *
 ...
 *   t('hud.landmark', '東門城')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '新竹城隍廟在呼喚你…！',
  'hud.goalGuide':    '朝新竹城隍廟前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全新竹。 / Roll up all of Hsinchu.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到新竹城隍廟 — From a 2cm pushpin to the City God Temple.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '新竹，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP HSINCHU',
