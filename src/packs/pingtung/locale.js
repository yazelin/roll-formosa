/**
 * @file locale.js — zh-TW string table for the Pingtung pack.
 *
 ...
 *   t('hud.landmark', '海生館')       // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '鵝鑾鼻燈塔在呼喚你…！',
  'hud.goalGuide':    '朝鵝鑾鼻燈塔前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全屏東。 / Roll up all of Pingtung.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到鵝鑾鼻燈塔 — From a 2cm pushpin to Eluanbi Lighthouse.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '屏東，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP PINGTUNG',
