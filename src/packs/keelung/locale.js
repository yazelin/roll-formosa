/**
 * @file locale.js — zh-TW string table for the Keelung pack.
 *
 ...
 *   t('hud.landmark', '慶安宮')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '正濱彩色屋在呼喚你…！',
  'hud.goalGuide':    '朝正濱彩色屋前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍雨都基隆。 / Roll up all of Keelung.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 彈珠，一路到正濱彩色屋 — From a 2cm marble to Zhengbin Colorful Houses.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '基隆，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP KEELUNG',
