/**
 * @file locale.js — zh-TW string table for the Taichung pack.
 *
 ...
 *   t('hud.landmark', '台中車站')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '台中之鑽在呼喚你…！',
  'hud.goalGuide':    '朝台中之鑽前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全台中。 / Roll up all of Taichung.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到 225m 台中之鑽 — From a 2cm pushpin to the Taichung Diamond.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '台中，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP TAICHUNG',
