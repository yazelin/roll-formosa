/**
 * @file locale.js — zh-TW string table for the New Taipei pack.
 *
 ...
 *   t('hud.rareFound')               // rare-found +5000  -> '發現稀有！+5000'
 *   t('hud.goalCall')                // goal toast
 *   t('hud.landmark', '九份老街茶樓')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '淡水漁人碼頭情人橋在呼喚你…！',
  'hud.goalGuide':    '朝情人橋前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全新北。 / Roll up all of New Taipei.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到淡水情人橋 — From a 2cm pushpin to Tamsui Lover\'s Bridge.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '新北，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP NEW TAIPEI',
