...
export const TIERS = [
  {
    ...
    objectsPerChunk: 72,
    archetypeIds: [
      // 土豆殼碎, 醬油蓋, 香腳, 瓶蓋, 花生, 尪仔標, 籤紙, 線香環
      'peanut_shell_bit', 'soy_sauce_cap', 'incense_stub', 'bottle_cap', 'peanut_pod', 'ngiauimia_card', 'fortune_slip', 'incense_coil',
  ...
  },
  {
    ...
    objectsPerChunk: 72,
    archetypeIds: [
      // 廟口板凳, 斗笠, 醬油甕, 瓦斯桶, 三角錐, 消防栓, 布袋戲偶盒, 雲林公車站牌
      'temple_bench', 'bamboo_hat', 'soy_sauce_urn', 'gas_cylinder', 'traffic_cone', 'fire_hydrant', 'puppet_box', 'yunlin_bus_stop',
  ...
  },
  {
    ...
    objectsPerChunk: 72,
    archetypeIds: [
      // 醬油工坊, 西螺豆腐厝, 穀倉, 超商, 公車, 垃圾車, 加油站, 騎樓柱
      'soy_sauce_workshop', 'xiluo_tofu_house', 'grain_silo', 'convenience_store', 'city_bus', 'garbage_truck', 'gas_station', 'arcade_pillar',
  ...
  },
  {
    ...
    objectsPerChunk: 72,
    archetypeIds: [
      // 布袋戲劇場, 咖啡莊園, 斗六車站, 濁水溪大橋, 大糧倉, 巨型看板, 玻璃帷幕街屋, 銀行
      'puppet_theater', 'coffee_estate', 'douliu_station_plaza', 'zhuoshui_bridge', 'large_granary', 'giant_billboard', 'glass_curtain_house', 'bank',
  ...
  },
  {
    ...
    objectsPerChunk: 72,
    archetypeIds: [
      // 大橋遠景, 稻田, 布袋戲館, 雲海觀景台, 糖廠煙囪, 高壓電塔, 屋頂機房, 農田
      'bridge_silhouette', 'rice_field', 'puppet_museum', 'observation_deck', 'sugar_factory_stack', 'power_pylon', 'rooftop_plant_room', 'farmland_block',
