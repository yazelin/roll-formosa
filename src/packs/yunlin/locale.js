/**
 * @file locale.js — zh-TW string table for the Yunlin pack.
 *
 ...
 *   t('hud.landmark', '北港朝天宮')  // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '西螺大橋在呼喚你…！',
  'hud.goalGuide':    '朝西螺大橋前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全雲林。 / Roll up all of Yunlin.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到 1939m 西螺大橋 — From a 2cm pushpin to Xiluo Bridge.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '雲林，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP YUNLIN',
