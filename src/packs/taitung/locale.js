/**
 * @file locale.js — zh-TW string table for the Taitung pack.
 *
 ...
 *   t('hud.landmark', '三仙台')      // landmark absorbed toast
...
const TABLE = {
  ...
  'hud.goalCall':     '三仙台八拱橋在呼喚你…！',
  'hud.goalGuide':    '朝三仙台八拱橋前進！',
  ...
  // ---- Title screen ----
  'title.subtitle':    '捲啊捲，捲遍全台東。 / Roll up all of Taitung.',
  'title.start':       '開始 / START',
  'title.seedLine':    '從 2cm 圖釘，一路到三仙台八拱橋 — From a 2cm pushpin to Sanxiantai Arch Bridge.',
  'title.personalBest': '個人最佳：',

  // ---- Win overlay ----
  'win.title':         '台東，全部捲走了！',
  'win.subtitle':      'YOU ROLLED UP TAITUNG',
